...
[![CRAN status](https://www.r-pkg.org/badges/version/vaRHC)](https://CRAN.R-project.org/package=vaRHC)
...
You can install the development version of vaRHC from [GitHub](https://github.com/) with:
