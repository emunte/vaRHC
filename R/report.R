...
vaRreport <-   function(vaRinfo, vaRclass, path.copy.file=NULL ){
  path.original.file = system.file("docs", "template.xlsx", package="vaRHC")
  if(!(file.exists(path.original.file))) stop("The excel template path must be provided, you can download it from https://github.com/emunte/Class_variants ")
