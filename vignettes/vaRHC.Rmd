...
results <- vaRbatch(all.variants= vcf.file, annotation="hg19", spliceai.program = TRUE, spliceai.reference = "/path/to/vcf.vcf", remote=TRUE, output.dir = output.dir, excel.results = FALSE, print.data.frame = TRUE)
```
